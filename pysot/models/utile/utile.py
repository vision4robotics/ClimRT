...
class HiFT(nn.Module):
    ...
    def __init__(self,cfg):
        ...
        self.transformer = Transformer(channel, 6, 1, 1)
    ...
    def forward(self, x, z, f):
        ...
        res2=self.conv2(self.xcorr_depthwise(x[1],z[1]))
        
        res3=self.conv3(self.xcorr_depthwise(f[1],z[1]))
        ...
        res=self.transformer((pos+res2).view(b,c,-1).permute(2, 0, 1),\
